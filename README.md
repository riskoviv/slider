...
2. Подписчик. Это может быть:
   1. HTMLInputElement с атрибутом `type="number"` при подписке на событие изменения значения или callback-функция, принимающая 1 аргумент типа **number**
   2. HTMLInputElement с атрибутом `type="checkbox` при подписке на событие изменения состояния или callback-функция, принимающая 1 аргумент типа **boolean**
...
При подписке на событие изменения значения
