...
### Последовательность действий, выполняемых в плагине сразу после инициализации
...
Затем создаётся Presenter, в его конструктор передаются  аргумента: jQuery-элемент, на котором был вызван метод инициализации плагина, и только что созданная Model.
