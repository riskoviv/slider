...
test | Запуск всех тестов проекта. Опционально после этой команды через пробел можно указать, какой именно файл / файлы тестов нужно запустить. _Более подробно об этом можно прочитать в [документации фреймворка Jest](https://jestjs.io/docs/cli)._
